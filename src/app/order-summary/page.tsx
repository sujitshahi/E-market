    ...
    <div className="min-h-screen">
      <div className="max-w-7xl mx-auto p-4">
        {hasSearched ? (
                ...
                {products.map((product, index) => (
                  ...
                  >
                    ...
                    <div className="p-4">
                      ...
                      <h3 className="font-semibold text-lg mb-2">{product.title}</h3>
                      <p className="text-sm text-gray-600 mb-3">{product.description}</p>
                      <p className="font-semibold text-gray-900 dark:text-gray-100">Price: ${product.price}</p>
          ...
          /* DISPLAY MESSAGE WHEN THERE IS NO ACTIVE SEARCH / NO ORDER SUMMARY PARAMETERS */
          <div className="text-center py-20 ">
            <i className="fa-solid fa-basket-shopping text-5xl text-gray-300 dark:text-zinc-700 mb-4"></i>
            <h2 className="text-2xl font-bold text-gray-700 dark:text-gray-200 mb-2">No Order Summary Available</h2>
